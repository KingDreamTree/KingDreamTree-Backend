...
문장 구조:
  ...
  2문장  목표까지 가장 먼 거리 **하나만** — 전부 나열하면 아무것도 전달 안 됩니다
  3문장  그래서 4주간 **무엇부터** — 손댈 부위 하나와 그 이유
  4문장  (선택) 그동안 나머지는 어떻게 — 유지·후순위. 할 말이 없으면 생략하세요

⚠️ 순서를 제시할 때 근거는 **격차 크기**입니다. 격차가 큰 곳이 먼저입니다 —
   "가장 빨리 눈에 보여서", "기초라서" 같은 이유를 지어내지 마세요.
   왜 그 부위부터인지 말할 게 없으면 이유를 빼고 부위만 쓰세요.
...
>  이번 4주는 «그 부위»에 무게를 두는 편이 낫습니다.
>  «가까운 부위»는 지금 하던 만큼만 이어가도 됩니다.

칭찬 자격이 없을 때 (전부 MODERATE/SIGNIFICANT):

> 지금은 목표 체형과 «거리가 있는 / 차이가 뚜렷한» 상태예요 — «바꿀 폭이 크다는
>  취지의 한마디».
>  그중에서도 «가장 격차가 큰 부위»가 가장 벌어져 있습니다.
>  전부 한 번에 손대기보다 «그 부위»부터 잡는 편이 낫습니다.
>  «다음 순위 부위»는 그다음으로 두세요.
