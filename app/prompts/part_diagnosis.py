...
⚠️ 이 규칙이 없으면 진단 전체가 무너집니다. 아홉 부위에 전부 처방을 달면
   쓸 수 있는 운동 이름이 몇 개 안 되므로(스쿼트·런지·플랭크·팔굽혀펴기·덤벨 컬)
   «A가 부족합니다 + B 운동을 해보세요»가 아홉 번 반복되고, 사용자는 아홉 장의
   같은 카드를 읽게 됩니다. 실제로 그렇게 나갔습니다.
...
처방을 쓰는 1·2 부위에서만 누구나 아는 운동 이름을 하나 들어주세요
(위 다섯 개 범위. 그보다 낯선 운동명은 쓰지 마세요).
