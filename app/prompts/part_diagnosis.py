...
## 🔴 세 가지 문형 — 상황마다 쓰는 틀이 다릅니다

부위 카드는 **본 것을 말하는 곳**입니다. "그래서 무엇을 하라"는 종합 진단이 맡습니다.
아래 세 틀 중 하나로 쓰세요. «» 안은 채워 넣을 자리입니다.

🔴 **두 문장은 따로 노는 두 개의 판정문이 아니라, 하나의 설명입니다.** 1문장이
   "무엇이 보이는지"라면 2문장은 "그게 왜 그렇게 보이는지"를 자연스럽게 이어서
   설명하세요 — "~때문에", "~해서", "~라서" 로 이어지는 말이 됩니다. "확인됩니다",
   "나타납니다" 로 딱딱하게 끊지 말고, 옆에서 짚어주듯 풀어서 쓰세요.

### ① 차이가 있을 때 (SIGNIFICANT · MODERATE)

    목표 체형과 비교하면 «부위»는 «무엇»이 «어떻게» 보입니다.
    «관찰 근거» 때문에 그렇게 보이는 것으로 읽힙니다.

  ⚠️ 위 두 줄은 **뼈대**입니다. 어미와 연결어는 부위마다 바꾸세요.
     아래는 «» 자리에 무엇이 들어가는지 보여주는 것일 뿐, 문장을 옮겨 적는
     견본이 아닙니다. 실측(2026-08-19): 예문을 그대로 두었더니 다섯 부위가
     **전부 같은 문장**으로 나왔습니다 ("…밋밋해서 그렇게 보이는 것으로,
     이번 비교에서 눈에 띄는 차이입니다").

  자리 채우기 참고 — «무엇»: 두께 · 굵기 · 윤곽선 · 근육의 경계 · 형태의 굴곡
                    «관찰 근거»: 사진에서 **직접 본 것**을 짧게

  ⚠️ 2문장이 같은 말이면 안 됩니다. 1문장은 **무엇이 다른가**, 2문장은
     **왜 그렇게 보이는가** 입니다.
  ⚠️ 같은 어미를 연달아 쓰지 마세요. 카드가 나란히 놓이면 즉시 티가 납니다 —
     "~보입니다 / ~읽힙니다 / ~인상입니다 / ~쪽에 가깝습니다" 처럼 돌려쓰고,
     연결어도 "~때문에 / ~해서 / ~탓에 / ~라서" 로 바꿔가며 씁니다.

### ② 차이가 작을 때 (SLIGHT · NONE)

    목표 체형과 비교했을 때 전체적인 형태가 «유사하게/크게 다르지 않게» 보입니다.
    지금은 «부위»보다 다른 부위의 차이가 더 크게 보여서, 여기는 아직 눈여겨볼
    단계는 아닙니다.

  ⚠️ 여기도 어미를 돌려 쓰세요 — 카드 다섯 장이 같은 끝맺음이면 복사한
     것처럼 읽힙니다. "지금 단계에서 먼저 볼 곳은 아닙니다 / 우선순위는
     낮은 편입니다 / 이번에는 두고 봐도 괜찮습니다" 처럼 바꿔 씁니다.

  ⚠️ 사소한 차이를 문제로 부풀리지 마세요. **상대적 위치**를 알려주는 것이
     이 틀의 목적입니다 — "여기는 지금 걱정할 곳이 아니다".

### ③ 판단 불가일 때 (gap_level 이 null)

    사진만으로는 «부위»의 «무엇»이 충분히 보이지 않아서
    목표 체형과 «무엇» 차이를 정확히 비교하기는 어렵습니다.

  ⚠️ «무엇»에는 **이 사진에서 실제로 가려진 것**을 넣으세요 (옷·각도·잘림).
     예문을 옮겨 적으면 가려지지도 않은 부위에 같은 말이 붙습니다.

  🔴 **이 틀은 반드시 다르게 읽혀야 합니다.** ①②와 섞이면 사용자는 판단이
     내려진 줄 압니다. "충분히 보이지 않아서", "비교하기는 어렵습니다" 를 반드시
     쓰고, **여기에 어떤 방향·처방도 붙이지 마세요.** 못 본 부위입니다.
...
🔴 **«왼팔 …은 / 오른팔 …은» 으로 문장을 시작하면 위반입니다.** 좌우 쌍 카드의
   주어는 언제나 «양쪽 …» 입니다. 실측(2026-08-19): 이 규칙을 두고도
   "왼팔 전완은 …" / "오른팔 전완은 …" 으로 나뉘어, 뒤 문장이 완전히 같은
