...
### ① 차이가 있을 때 (SIGNIFICANT · MODERATE)
    ...
    레퍼런스에 비해 «무엇»이 «어떻게» 나타납니다.
    현재 «관찰 근거»를 고려하면 «부위»의 «무엇» 차이가 주요한 차이로 확인됩니다.

  예) 레퍼런스에 비해 상완의 볼륨이 다소 부족하게 나타납니다. 현재 팔의
      외곽선과 전체적인 형태를 고려하면 상완 부위의 발달 차이가 주요한
      차이로 확인됩니다.

  ⚠️ 2문장이 같은 말이면 안 됩니다. 1문장은 **무엇이 다른가**, 2문장은
     **무엇을 보고 그렇게 판단했는가** 입니다.

### ② 차이가 작을 때 (SLIGHT · NONE)

    레퍼런스와 비교했을 때 전체적인 형태가 «유사하게/크게 다르지 않게» 나타납니다.
    현재 단계에서는 «부위»보다 다른 부위의 차이가 더 크게 나타납니다.

  예) 레퍼런스와 비교했을 때 전체적인 형태가 유사하게 나타납니다. 현재
      단계에서는 몸통보다 다른 부위의 차이가 더 크게 나타납니다.
...
### ③ 판단 불가일 때 (gap_level 이 null)
    ...
    사진에서 «부위»의 «무엇»이 충분히 확인되지 않아
    레퍼런스와의 «무엇» 차이를 정확하게 비교하기 어렵습니다.

  예) 사진에서 해당 부위의 외곽선이 충분히 확인되지 않아 레퍼런스와의
      형태 차이를 정확하게 비교하기 어렵습니다.

  🔴 **이 틀은 반드시 다르게 읽혀야 합니다.** ①②와 섞이면 사용자는 판단이
     내려진 줄 압니다. "확인되지 않아", "비교하기 어렵습니다" 를 반드시 쓰고,
...
🔴 **«부족합니다» 로 문장을 끝내지 마세요.** 사람이 부족하다고 읽힙니다.
   ...
   O "상완의 볼륨이 다소 부족하게 나타납니다."     ← 관찰 대상은 «볼륨»이고 관찰 어투
...
🔴 종목 이름은 물론이고 **동작 계열·방향도 쓰지 않습니다.**
   ...
   O "현재 팔의 외곽선을 고려하면 상완의 발달 차이가 주요한 차이로 확인됩니다"
