...
_ADVICE_ENDINGS = (
    ...
    "해보세요",
    "바랍니다",
    # ⚠️ **부드러운 종결형도 같이 막는다** (2026-09-10). 부위 카드 어투를
    #    진단서 문어체에서 «옆에서 짚어주듯»(~해요/~고요)으로 바꾸면서, 처방도
    #    같은 어투로 나온다. 이 필터는 낱말이 아니라 **어미**로 가르므로
    #    "좋습니다" 만 막아두면 "좋아요" 가 그대로 통과한다 —
    #    "여기를 키우면 좋아요" 처럼 종목 이름이 없는 처방은
    #    _strip_exercise_names 도 못 잡는다.
    "좋아요",
    "필요해요",
    "권해요",
    "추천해요",
