...
BODY_PARTS: list[tuple[str, str, str, str | None, bool, str | None, int]] = [
    ...
    ("Left_Upper_Arm", "왼쪽 상완", "UPPER", "LEFT_ARM", True, "#F76707", 2),
    ("Left_Lower_Arm", "왼쪽 전완", "UPPER", "LEFT_ARM", True, "#FFA94D", 3),
    ("Right_Upper_Arm", "오른쪽 상완", "UPPER", "RIGHT_ARM", True, "#2F9E44", 4),
    ("Right_Lower_Arm", "오른쪽 전완", "UPPER", "RIGHT_ARM", True, "#69DB7C", 5),
